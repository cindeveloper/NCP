    ...
    public partial class frmQuanLyKhachHang : Form
    {
        ...
        private void dgvDanhSachKH_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvDanhSachKH.Rows[e.RowIndex].Cells[e.ColumnIndex].Value != null)
            {
                ...
                txtSDT.Text = dgvDanhSachKH.Rows[e.RowIndex].Cells[0].Value.ToString();
                txtHoTen.Text = dgvDanhSachKH.Rows[e.RowIndex].Cells[1].Value.ToString();
                txtDiaChi.Text = dgvDanhSachKH.Rows[e.RowIndex].Cells[2].Value.ToString();
            }
        }
